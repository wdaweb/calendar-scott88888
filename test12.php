...
echo "<style>".":root {--number:" .$colorNum .";}"."</style>";
...
<div class="botBreathe"><a href="test12.php?ColNum=<?=$numdel?>&mon=<?=$numdel?>">上個月</div></a>
<div class="botBreathe"><a href="test12.php?ColNum=<?=$mon;?>&mon=<?=$mon;?>">顯示是<?=$mon;?>月</div></a>
<div class="botBreathe"><a href="test12.php?ColNum=<?=$numadd?>&mon=<?=$numadd?>" >下一個月</a></div>
...
<div class="botBreathe"><a href="test12.php?ColNum=0&mon=<?=$mon;?>">color1</a></div>
<div class="botBreathe"><a href="test12.php?ColNum=1&mon=<?=$mon;?>">color2</a></div>
<div class="botBreathe"><a href="test12.php?ColNum=2&mon=<?=$mon;?>">color3</a></div>
<div class="botBreathe"><a href="test12.php?ColNum=3&mon=<?=$mon;?>">color4</a></div>
<div class="botBreathe"><a href="test12.php?ColNum=4&mon=<?=$mon;?>">color5</a></div>
<div class="botBreathe"><a href="test12.php?ColNum=5&mon=<?=$mon;?>">color6</a></div>
<div class="botBreathe"><a href="test12.php?ColNum=6&mon=<?=$mon;?>">color7</a></div>
<div class="botBreathe"><a href="test12.php?ColNum=7&mon=<?=$mon;?>">color8</a></div>
<div class="botBreathe"><a href="test12.php?ColNum=8&mon=<?=$mon;?>">color9</a></div>
<div class="botBreathe"><a href="test12.php?ColNum=9&mon=<?=$mon;?>">color10</a></div>
<div class="botBreathe"><a href="test12.php?ColNum=10&mon=<?=$mon;?>">color11</a></div>
<div class="botBreathe"><a href="test12.php?ColNum=11&mon=<?=$mon;?>">color12</a></div>
</div>  -->




<form action="test12.php" method="get">
<input type="color" name="colorNum" value="#FF0000"/>
