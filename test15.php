...
body{
    ...
    .BreatheBigBox{
           ...
           animation: BreatheFont 5s linear infinite , BreatheBorder 3s  linear infinite;
           display: flex;
           align-items:center;
        }
            ...
            @keyframes BreatheBorder{
                0%{
                    box-shadow:0px 0px 1px 1px var(--number),0px 0px 1px 1px var(--number),inset 0px 0px 1px 1px var(--number) ;
                }
                50%{
